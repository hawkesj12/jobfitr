...
having a single, self-contained prompt here that:
  - describes the 8 fields plainly,
...
# The field contract (same 8 fields as jobfitr.config_builder / SET_CONFIG_TOOL).
EXTRACT_PROMPT = (
    ...
    "The 8 config fields (include only fields the transcript actually supports; omit "
